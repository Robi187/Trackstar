...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        // --- CONTENT ---
        $contentsData = [
           ['Midnight Vibes',        'Chill Afro Track mit smoothen Vocals.',     'tracks/midnight_vibes.mp3',       0, 0, 0],  // Track, Afro
    ['Trap God Beat',         'Harter Trap Beat mit 808s und Hi-Hats.',    'beats/trap_god.mp3',              1, 1, 1],  // Beat, Trap
    ['Drill Season',          'Dark UK Drill Instrumental.',               'beats/drill_season.mp3',          1, 2, 2],  // Beat, Drill
    ['Balkan Fire',           'Energetischer Balkan-inspirierter Track.',  'tracks/balkan_fire.mp3',          0, 3, 6],  // Track, Balkan
    ['808 Bass Sample Pack',  'Fette 808 Basslines für deine Beats.',      'samples/808_bass_pack.zip',       2, 0, 1],  // Sample, Trap
    ['Detroit Techno Kit',    'Classic Detroit Sound Kit mit Drums.',      'soundkits/detroit_techno.zip',    3, 1, 4],  // Sound Kit, Detroit
    ['RnB Melodie',           'Smooth RnB Loop mit Piano und Strings.',    'tracks/rnb_melodie.mp3',          0, 2, 5],  // Track, RnB
    ['Latin Heat',            'Feuriger Latin Beat mit Percussion.',       'beats/latin_heat.mp3',            1, 3, 7],  // Beat, Latin
    ['Skrilla Flow',          null,                                        'tracks/skrilla_flow.mp3',         0, 0, 8],  // Track, Skrilla
    ['Drill Hi-Hat Loops',    'Crispy Hi-Hat Loops für Drill Beats.',      'samples/drill_hihats.zip',        2, 1, 2],  // Sample, Drill
    ['Trap Drum Kit Vol.1',   'Komplettes Trap Drum Kit mit Claps.',       'soundkits/trap_drums_vol1.zip',   3, 2, 1],  // Sound Kit, Trap
    ['House Groove',          'Deep House Loop mit klassischem Feel.',     'tracks/house_groove.mp3',         0, 3, 3],  // Track, House
        ];
        $contents = [];
        foreach ($contentsData as [$title, $desc, $path, $catIdx, $userIdx, $tagIdx]) {
            $content = new Content();
        ...
        // --- CONTENT TAGS ---
        $contentTagPairs = [
            [0,  0], [0,  5],  // Midnight Vibes       → Afro, RnB
            [1,  1], [1,  8],  // Trap God Beat        → Trap, Skrilla
            [2,  2], [2, 10],  // Drill Season         → Drill, 21 Savage
            [3,  6], [3,  7],  // Balkan Fire          → Balkan, Latin
            [4,  1], [4,  8],  // 808 Bass Sample Pack → Trap, Skrilla
            [5,  4],           // Detroit Techno Kit   → Detroit
            [6,  5], [6,  9],  // RnB Melodie          → RnB, Drake
            [7,  7], [7,  0],  // Latin Heat           → Latin, Afro
            [8,  8], [8,  1],  // Skrilla Flow         → Skrilla, Trap
            [9,  2],           // Drill Hi-Hat Loops   → Drill
            [10, 1], [10, 2],  // Trap Drum Kit        → Trap, Drill
